...
def statOnly(trans, lt=[], fname="", encoding="utf-8", sep="\t"):
    ...
    with open(csv, 'w', encoding=encoding) as file:
        file.write("Index"+sep+"startA"+sep+"endA"+sep+"startB"+sep+"endB"+sep+"len(A)"+sep+"len(B)"+sep+"ratio"+sep+
                   "Onset"+sep+"on_ms"+sep+"Offset"+sep+"off_ms\n")
        ratio = 0.; start = 0; end = 0; durA = 0.; durB = 0.
        for a in range(len(l_bound)):
            sA,eA,sB,eB = l_bound[a][0:4]
            ...
            if durA <= 0:
                ...
                ratio = (durB/durA)*100
            file.write("{}{}{:.3f}{}{:.3f}{}{:.3f}{}{:.3f}{}{:.3f}{}{:.3f}{}{:.2f}%{}{}{}{}{}{}{}{}\n"
                       .format(a,sep,sA,sep,eA,sep,sB,sep,eB,sep,durA,sep,durB,sep,ratio,sep,
